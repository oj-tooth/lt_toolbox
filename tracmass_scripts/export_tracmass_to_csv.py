################################################################
# export_tracmass_to_csv.py
# --------------------------------------------------------------
# Description: Script to transform TRACMASS Lagrangian particle
# tracking output run.csv files into individual .csv files.
#
...
iniFile = 'ORCA1-N006_eSPNA_1975_1979_ini.csv'
...
runFile = 'ORCA1-N006_eSPNA_1975_1979_run.csv'
# ---------------------------------------------------------------------
...
# ------------- Header to Script -------------
print('~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~')
print('==== Exporting TRACMASS Output from csv to individual csv files ====')
print('~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~')
print('-- Description --')
print('Script to export TRACMASS Lagrangian particle')
print('tracking output to store trajectories released')
print('at each seeding step in individual csv files.')
print('~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~')
print('-- Info --')
...
for n in tqdm(range(nsteps)):
    ...
    # ---------------------------------------------------------------------------
    # Stage 2:
    # Saving extracted particle trajectories to new _run.csv file.

    # Defining filename:
    fname = outFile + date_str[n] + '_run.csv'
    # Save DataFrame to .csv file without headers:
    df_run.to_csv(path_or_buf=outDir+fname, header=False, index=False)
# ------------- Footer to Script -------------
print('Completed: Exported TRACMASS .csv to individual .csv files')
print('~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~')
# ------------- Footer to Script -------------
